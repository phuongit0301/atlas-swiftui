//
//  ClipboardDepartureCompletedNoteView.swift
//  ATLAS
//
...
struct ClipboardDepartureCompletedNoteView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ClipboardDepartureCompletedNoteItemList(
                header: header,
                showSheet: $showSheet,
            ...
            ClipboardDepartureCompletedNoteRelevantList(
