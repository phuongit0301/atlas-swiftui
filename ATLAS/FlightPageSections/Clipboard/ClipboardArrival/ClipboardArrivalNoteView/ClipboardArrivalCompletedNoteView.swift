//
//  ClipboardArrivalCompletedNoteView.swift
//  ATLAS
//
...
struct ClipboardArrivalCompletedNoteView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ClipboardArrivalCompletedNoteItemList(
                header: header,
                showSheet: $showSheet,
            ...
            ClipboardArrivalCompletedNoteRelevantList(
