//
//  EnrouteModalNoteCommentView.swift
//  ATLAS
//
...
struct EnrouteModalNoteCommentView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            if coreDataModel.dataNoteAabbaEnroute.count > 0 {
                if let payload = coreDataModel.dataNoteAabbaEnroute[parentIndex].posts, let posts = payload.allObjects as? [NotePostList] {
                    self.posts = posts
