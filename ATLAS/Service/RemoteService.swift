...
//            let convertedString = String(data: postData!, encoding: .utf8)
    ...
    func updateMapTrafficData(_ parameters: Any, completion: @escaping (_ success: Bool) -> Void) async  {
    ...
    func updateMapAabbaData(_ parameters: Any, completion: @escaping (_ success: Bool) -> Void) async  {
    ...
    func updateMapWaypointData(_ parameters: Any, completion: @escaping (_ success: Bool) -> Void) async  {
    ...
    func updateMapAirportData(completion: @escaping (_ success: Bool) -> Void) async  {
    ...
    func updateNotamData(_ parameters: Any, completion: @escaping (_ success: Bool) -> Void) async  {
