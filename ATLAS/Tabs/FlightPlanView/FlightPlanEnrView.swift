                ...
                List {
                    ...
                    Section(header:Text("WAYPOINTS").font(.system(size: 15, weight: .semibold)).foregroundStyle(Color.black)) {
                        ...
                        HStack {
                            ...
                            Group {
                                Text("VWS\n\nDRM").font(.system(size: 15, weight: .medium)).frame(width: calculateWidth(proxy.size.width - 50, 13), alignment: .leading)
                                Text("ZFRQ\n\nPFRM").font(.system(size: 15, weight: .medium)).frame(width: calculateWidth(proxy.size.width - 50, 13), alignment: .leading)
